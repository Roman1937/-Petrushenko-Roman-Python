...
def get_available_letters(letters_guessed):
    ...
    for i11 in letters_guessed:
        a_letters = a_letters.replace(i11, "")
    return a_letters
...
""")
    while True:
        print("-----------")
        if is_word_guessed(secret_word, l_guessed1) == True:
        ...
        print(f"Available letters: {get_available_letters(l_guessed)}")
